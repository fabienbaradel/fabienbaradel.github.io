...
\begin{enumerate}[wide=0pt]
	...
	\item \textbf{F. Baradel}, N. Neverova, J. Mille, G. Mori, C. Wolf. "Counterfactual Learning of Physical Dynamics", \textit{submitted to The IEEE International Conference on Computer Vision (ICCV)}. 2019.% \textbf{3 citations}.
